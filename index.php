...
<body>
    ...
    ?>
            ...
            <section class="body">
                <div class="inner">
                    ...
                    <div class="formbody border border-success rounded shadow px-5 py-5">
                        ...
                        <p class="text-left form-tip">我的面试 笔试信息</p>
                        ...
                        <table class="table table-bordered table-hover mt-3">
                            <thead>
                                <tr>
                                    <th scope="col">序号</th>
                                    <th scope="col">姓名</th>
                                    <th scope="col">我的星级</th>
                                    <th scope="col">我的记录</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody class="tbody">
        ...
        <?php
        } else if (!empty($_GET['hisreview'])) {
        ?>
            <!-- script hisreview js -->
            <script src="./js/hisreview.js"></script>
            <title>的面试记录 | 青春在线程序部纳新</title>
            </head>
                ...
                <section class="body">
                    <div class="inner">
                        ...
                        <div class="formbody border border-success rounded shadow px-5 py-5">
                            ...
                            <p class="text-left form-tip">笔试信息</p>
                            ...
                            <table class="table table-bordered table-hover mt-3">
                                <thead>
                                    <tr>
                                        <th scope="col">受试者姓名</th>
                                        <th scope="col">面试者姓名</th>
                                        <th scope="col">面试记录</th>
                                        <th scope="col">星级评价</th>
                                        <th scope="col"></th>
                                    </tr>
                                </thead>
                                <tbody class="tbody">
